...
2. **Looking for phase milestones?** → `phase-completions/PHASE*.md`
3. **Looking for migration history?** → `completed-migrations/`
4. **Looking for old plans?** → `superseded-plans/UNIFIED_*.md`
5. **Looking for integration docs?** → `integration-docs/`
