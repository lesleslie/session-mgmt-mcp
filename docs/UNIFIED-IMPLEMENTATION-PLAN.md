...
2. [ ] Prioritize 14 test collection errors (1 hour)
3. [ ] Fix SessionLogger DI registration in fixtures (2 hours)
...
2. [ ] Verify 0 collection errors (1 hour)
...
2. **Deferring YAGNI work** (templates, events, query interfaces)
3. **Fixing critical blocker first** (test infrastructure Week 3)
4. **Clear sequencing** (tests → coverage → release → rollout → excellence)
