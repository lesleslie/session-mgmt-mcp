...
2. **KISS (Keep It Simple)**: Removed unnecessary complexity
3. **YAGNI (You Ain't Gonna Need It)**: Removed unused imports
4. **Pythonic**: Used `*_exc_info` for unused parameters (PEP 8)
